...
* [angrymlocker](https://github.com/FiloSottile/otherport) - library for keeping corresponding process in memory
...
* [flockit](https://github.com/FiloSottile/otherport) - add file locking to programs that don't do it
...
* [openssl-hook](https://github.com/FiloSottile/otherport) - log data to/from SSL\_write/SSL\_read to disk
